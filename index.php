  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#service">Mobile Recharge</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#signup">Shopping Payment</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#discover">Blog</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#discover">Affiliates</a>
        </li>
        <li class="nav-item">
...
<div class="mid">
	...
	<div class="hero text-center">
		<h2 class="text-light display-4 font-weight-bold">Fastechanger is a Digital solution for Freelancers.</h2>
		<p class="text-light mx-auto">We can help you to Send, Receive, Exchange, Shopping payment, or accept online payment easily on your personal account.</p>
...
<section id="discover" class="discovery py-5">
  <div class="row align-items-center container my-5 mx-auto">
    ...
    <div class="text col-lg-6 col-md-6 col-12 w-50 pt-2 pb-5">
      ...
      <h6>In this section, you can get detailed information about the Fastechanger system. If after reading this document, you still have any problems or questions about the system, please contact us.</h6>
      
      <h5 onclick="myFunction1()" class="bg-info">What is Fastechanger? </h5>
      

      <p id="myfirstDIV" style="display: none;" class="bg-warning">Fastechanger is a simple and fast e-currency exchange for freelance service. You just need to register, and verify. We'll quickly convert transaction for you without charging any additional or hidden fees.</p>
